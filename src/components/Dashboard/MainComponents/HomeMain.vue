<template class="wrapper">
    ...
    >
        ...
        <tbody>
            <tr
                v-for="car in carsSoldData"
                :key="car._id"
            >
                <td class="table-car-name">{{ car.carId.name + " " + car.carId.model }}</td>
                <td class="table-car-img">
                    <img class="img-car" :src="car.carId.images[6]" >
                </td>
                <td class="table-car-year">{{ car.carId.year }}</td>
                <td class="table-car-time-sale">{{ car.day+"/"+car.month+"/"+car.year }}</td>
 ...
 <script>
    ...
    export default {
        ...
        setup(){
            ...
            const carousel = [{
                src:"/assets/PorscheCarousel1.jpg"
            },{
                src:"/assets/PorscheCarousel2.jpg"
            }]
            onBeforeMount(async () =>{
            ...
            return {cards, carousel, carsSoldData};
        }
